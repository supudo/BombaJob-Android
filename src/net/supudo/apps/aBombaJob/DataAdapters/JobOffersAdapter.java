...
public class JobOffersAdapter extends ArrayAdapter<JobOfferModel> {
	...
	public JobOffersAdapter(Context context, int textViewResourceId, ArrayList<JobOfferModel> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.list_item_subtitled, parent, false);
