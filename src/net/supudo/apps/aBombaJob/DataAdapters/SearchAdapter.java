...
public class SearchAdapter extends ArrayAdapter<JobOfferModel> {

	private LayoutInflater mInflater;
	private ArrayList<JobOfferModel> items;
	private Context context;

	public SearchAdapter(Context context, int textViewResourceId, ArrayList<JobOfferModel> items) {
