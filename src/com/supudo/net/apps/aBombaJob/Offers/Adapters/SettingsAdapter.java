package com.supudo.net.apps.aBombaJob.Offers.Adapters;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.infoIcon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	String info = dbHelper.GetTextContentForSetting((String)v.getTag());
		...
		holder.settingSwitch.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				if (sName.equalsIgnoreCase("StorePrivateData"))
					CommonSettings.stStorePrivateData = Boolean.getBoolean(sValue);
				else if (sName.equalsIgnoreCase("SendGeo"))
					CommonSettings.stSendGeo = Boolean.getBoolean(sValue);
				else if (sName.equalsIgnoreCase("InitSync"))
					CommonSettings.stInitSync = Boolean.getBoolean(sValue);
				else if (sName.equalsIgnoreCase("OnlineSearch"))
					CommonSettings.stSearchOnline = Boolean.getBoolean(sValue);
				else if (sName.equalsIgnoreCase("InAppEmail"))
					CommonSettings.stInAppEmail = Boolean.getBoolean(sValue);
				else if (sName.equalsIgnoreCase("ShowCategories"))
					CommonSettings.stShowCategories = Boolean.getBoolean(sValue);
	        }
		});
