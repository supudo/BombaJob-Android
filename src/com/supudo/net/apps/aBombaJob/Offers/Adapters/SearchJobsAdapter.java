...
public class SearchJobsAdapter extends ArrayAdapter<JobOfferModel> {

	private LayoutInflater mInflater;
	private ArrayList<JobOfferModel> items;
	private Context context;

	public SearchJobsAdapter(Context context, int textViewResourceId, ArrayList<JobOfferModel> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			Log.d("SearchJobs", "Date parser failed - " + off.PublishDate);
		}
