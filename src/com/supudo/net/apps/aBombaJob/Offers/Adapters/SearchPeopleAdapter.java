...
public class SearchPeopleAdapter extends ArrayAdapter<JobOfferModel> {

	private LayoutInflater mInflater;
	private ArrayList<JobOfferModel> items;
	private Context context;

	public SearchPeopleAdapter(Context context, int textViewResourceId, ArrayList<JobOfferModel> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			Log.d("SearchPeople", "Date parser failed - " + off.PublishDate);
		}
		holder.subtitle.setText(osubtitle);

		if (off.SentMessageYn)
			holder.icon.setImageResource(R.drawable.messagesent);
